...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Personal Dev Tools'),
    );
  }
}
        ...
        child: Scaffold(
          ...
          body: const TabBarView(
            children: [
              TextFormatterPage(
                inputLabel: 'JSON',
                formattedLabel: "Formatted JSON",
                formatFunc: parseAndFormatJSON,
              ),
              TextFormatterPage(
                inputLabel: 'String',
                formattedLabel: "In Query",
                formatFunc: parseAndFormatInQuery,
              ),
              TextFormatterPage(
                inputLabel: 'Env Variable',
